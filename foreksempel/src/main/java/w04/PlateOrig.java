...
/**
 * Bilskilt kunne kanskje ha blitt lagret som en variabel i bilen, men dette er
 * mye finere. Får også frem validering av regnr. Viser frem testing med if, men
 * også JUnit. Det er penere.
 * 
 * @author borgeha
 *
 */
public class PlateOrig {
	...
	/**
	 * Hold musen over metodenavnet checkSign. Se at hjelpen som popper opp er den
	 * samme som står lenger ned i denne kommentaren. For å lage slike, skriv /** på
	 * linjen før en metode, og trykk linjeskift. Er registreringsnummeret reelt? 2
	 * store bokstaver, 5 siffer.
	 * 
