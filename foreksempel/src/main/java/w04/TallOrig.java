...
/**
 * Dette er et eksempel på at en kan benytte seg av andre måter å lagre verdier
 * enn de en reelt henter ut med get-metoder. Også et eksempel på at en an lage
 * flere get, og la objektet regne dem ut. Til slutt et eksempel på hvordan en
 * overskriver Object-klassen sin toString().
 * 
 * @author borgeha
 *
 */
