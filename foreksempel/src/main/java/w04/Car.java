...
public class Car {
	...
	/**
	 * Jeg har her skissert slik jeg ønsker at en bil skal oppføre seg. Så er det
	 * opp til meg å bestemme hvordan dette skal løses internt ved oppdeling av
	 * objekter og ansvar.
	 * 
	 * @param args
	 */
	public static void main(String[] args) {
		...
		/*
		 * Jeg sa at jeg skulle få laget en måte jeg kan bruke returverdi på. Her
		 * returnerer addHiker boolean basert på om den faktisk får plass til en person
		 * eller ikke. Det er derimot ikke en veldig bra måte å gjøre ting synes jeg.
		 * Jeg har lagt inn en ny metode getHikerAmount() som returnerer antallet
		 * passasjerer. Denne kan en teste mot, se under.
		 * 
		 * Hvis du synes dette ser vanskelig ut, husk at en heller kan skrive ut hva som
		 * skjer.
		 */
		...
		// Dette er bare en smakebit på hva dere kommer til å lære i løpet av våren.
		// Dette er effektiv koding!
		// HUSK: DERE SKAL IKKE kunne det i løpet av uken, men tenk så kult det blir å
		// kunne!
		...
		// ...til hit. Så kan du avgjøre selv hva som er mest forståelig når kommer til
		// mai og skjønner alt.
		// streams har en drøss andre fordeler også, men det tar vi om en måned eller
		// to!
	}
	...
	/*
	 * Jeg kunne endret denne til void, og heller valgt å lage en metode som
	 * returnerer antallet personer som sitter på i bilen, som kan brukes til å
	 * sjekke at tilstanden er korrekt. Denne laget jeg allikevel. I tillegg vil en
	 * gjerne ha sjekker om om Personen p faktisk ER passasjer i bilen, og slikt,
	 * men eksempelet her er ikke komplett.
	 */
	...
	/*
	 * Her kan en sløyfe boolean. En kan lage en metode getDriver(), og sjekke at
	 * denne er endret eller ikke. Jeg bruker ikke boolean, men den kan jo brukes i
	 * testing.
	 */
