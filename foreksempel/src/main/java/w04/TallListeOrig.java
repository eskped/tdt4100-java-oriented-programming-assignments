...
/**
 * Kunne ikke finne noe mer merkelig eksempel på at intern lagring kan være
 * annerledes enn utseendet på klassen, enn ved å lagre heltall som lister av
 * chars (tallet 13 blir chars '1' og '3' i liste).
 * 
 * @author borgeha
 *
 */
public class TallListeOrig {
	...
	/**
	 * Tar inn et heltall, returnerer en liste med chars som er like. Eksempel: inn
	 * 13 gir ut [1,3]
	 * 
	 * @param tall
	 * @return
	...
	/**
	 * Her ønsker vi å rett og slett bare returnere strengen av heltallet. Vi vil
	 * altså omgå den grusomme måten vi lagrer det internt som liste.
	 */
	@Override
