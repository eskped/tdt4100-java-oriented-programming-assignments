...
public class Frukt {
	...
	// Termen 'settere og gettere' blir dere kjent med. Vi bør ikke hente ut
	...
	public static void main(String[] args) {
		...
		System.out.println("Skrive ut objektreferanser:"); // For å slippe å skrive alt det her: skriv sys, og så
															// trykker du på kontroll-mellomrom.
