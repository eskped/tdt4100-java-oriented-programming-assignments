...
import w09.jokey.v0902.core.jokes.JokesChuckNorrisRepository;
import w09.jokey.v0902.core.jokes.JokesMemoryRepository;
import w09.jokey.v0902.core.jokes.JokesRepositoryManager;
import w09.jokey.v0902.core.jokes.JokesWockaFileRepository;
...
public class JokeyApp extends Application {
	...
	public void init() throws Exception {
		...
		JokesChuckNorrisRepository cnRep = new JokesChuckNorrisRepository();
		repositoryManager.addRepository(cnRep);
