...
public class JokesRepositoryManager {
	...
	/**
	 * Returnerer en instans av JokesRepositoryManager.
	 * 
	 * @return instansen av JokesRepositoryManager
	 */
	...
	public IJokesRepository getRepository(IJokeyIdentifier repositoryId) {
		if (repositoryId != null)
			return getRepository(repositoryId.getIdentifierAsString());
		return null;
	}
	 ...
	 * @return
	 */
	public IJokesRepository getRepository(String repositoryId) {
		if (repositoryId != null)
