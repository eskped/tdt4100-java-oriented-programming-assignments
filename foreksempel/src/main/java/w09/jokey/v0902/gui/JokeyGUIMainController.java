package w09.jokey.v0902.gui;

import javafx.fxml.FXML;
import javafx.scene.control.Label;
import javafx.util.StringConverter;
import w09.jokey.v0902.JokeyApp;
import w09.jokey.v0902.core.Constants;
import w09.jokey.v0902.core.jokes.IJokes;
import w09.jokey.v0902.core.jokes.IJokesRepository;
import w09.jokey.v0902.core.jokes.Joke;
import w09.jokey.v0902.core.jokes.JokesRepositoryManager;
import w09.jokey.v0902.core.storage.AppPropertiesManager;
import w09.jokey.v0902.user.User;
...
public class JokeyGUIMainController {
	...
	public void onRandomJokeAction() {
		...
		boolean done = jokes.getJokesCount() != -1 && user.getUserData().getUniqueJokesSeenCount() >= jokes.getJokesCount();
		if (done) {
