...
public class StreamExamples {
	...
	public static void main(String[] args) throws IOException {
		...
		// Fjerne de første seks elementene i en intstream fra 0 til 10, og telle
		// elementer:
		...
		System.out.println(IntStream.range(0, 200)
				.filter(t -> t % 3 == 0)
				.filter(t -> t % 7 == 0)
				.reduce(0, (sum, i) -> sum + i)
				);

		// Lage en kontinuerlig strøm av heltall som deles på et annet tall, og så
		// skrive ut de første 100:
		System.out.println("\nBare et skrudd eksempel på hva en kan. Limit er bra, ellers ville den fortsatt...");
		IntStream.range(0, 99999)
//		.range(0,999999999)
		...
		List<String> folk = Arrays.asList("Al", "Skybert", "Farfarharetlangtnavn", "Farmor", "Håvard", "Jørn", "Andrea",
				"Børge");
		...
		// Lage en samling som inneholder alle personene som starter med "A" og lengde
		// over fire.
		...
		// Merk spesialtilfelle. På denne måten MÅ… en ikke innkapsle i try. Det må en
		// uten streams.
		System.out.println(
				new BufferedReader(new InputStreamReader(StreamExamples.class.getResourceAsStream("bands.txt"))).lines()
						// Over: hvis du bruker linjen over i en annen metode enn main, bytt ut
						// klassenavn.class med getClass()
		...
		// BinaryOperator:
		/*
		 * Reduce bruker denne. Reduce tar inn to tall og returnerer summen. Det kule er
		 * at man husker sum til neste gang den kjøres! Første parameter i reduce
		 * bestemmer hva sum skal være første gang reduce kalles. Neste gang kjøres den
		 * nåværende verdien av sum inn. På denne måten kan en legge sammen alle
		 * verdiene i rekken.
		 */
		...
		// UnaryOperator:
		// Interface som tar inn et element, og gjør noe med det. map bruker
		// UnaryOperator!
