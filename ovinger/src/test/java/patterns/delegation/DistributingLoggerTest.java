...
public class DistributingLoggerTest{
	...
	public void testLogToInfo() {
		...
		Assertions.assertEquals(String.format(formatString, ILogger.INFO, "Dette er en info-melding.", null), infoStream.toString().trim(), "Teste formatet på info-meldingen etter logging");
	...
	public void testLogToWarn() {
		...
		Assertions.assertEquals(String.format(formatString, ILogger.WARNING, "Dette er en advarsel.", null), warnStream.toString().trim(), "Teste formatet på warning-meldingen etter logging");
	...
	public void testLogToError() {
		...
		Assertions.assertEquals(String.format(formatString, ILogger.ERROR, "Dette er en feilmelding.", exception), errorStream.toString().trim(), "Teste formatet på error-meldingen etter logging");
	...
	public void testChangeInfoLogger() {
		...
		infoLogger.setFormatString(formatString);
		logger.log(ILogger.INFO, "Dette er en info-melding.", null);
		Assertions.assertEquals(String.format(formatString, ILogger.INFO, "Dette er en info-melding.", null), infoStream.toString().trim(), "Teste formatet på info-melding etter logging");
		...
		Assertions.assertEquals(String.format(formatString, ILogger.INFO, "Dette er en info-melding.", null), infoStream.toString().trim(), "Teste første info-strøm etter å ha byttet infologger og logget enda en info-melding");
		Assertions.assertEquals(String.format(formatString, ILogger.INFO, "Dette er den andre info-meldingen.", null), newInfoStream.toString().trim(), "Teste andre info-strøm etter å ha byttet infologget og logget ny info-melding");
	}
