...
public class ManagerTest {
	...
	public void testResourceCount() {
		Assertions.assertEquals(2, manager.getResourceCount(), "Teste antall ressurser for en manager uten mellomledere");
	}
	...
	public void testPrintDocuments() {
		...
		Assertions.assertTrue(printer.getPrintHistory(clerk).contains("dokument1"), "Teste at printerhistorikken inneholder dokumentet som ble printet");
		...
		Assertions.assertEquals(1, printer.getPrintHistory(clerk).size(), "Teste antall utskrifter i printerhistorikken etter 1 utskrift");
	}
	...
	public void testTaskCount() {
		...
		Assertions.assertEquals(2, clerk.getTaskCount(), "Teste antall oppgaver for arbeider etter 1 utskrift og 1 beregning");
		Assertions.assertEquals(2, manager.getTaskCount(), "Teste antall oppgaver for manager etter 1 utskrift og 1 beregning");
	}
	...
	public void testSeveralClerks() {
		...
		Assertions.assertEquals(3, multiManager.getResourceCount(), "Teste antall ressurser for manager med to arbeidere");
		...
		Assertions.assertTrue((clerk.getTaskCount() == 1 || secondClerk.getTaskCount() == 1) && (clerk.getTaskCount() == 0 || secondClerk.getTaskCount() == 0), "Teste at kun en av arbeiderne har utført en oppgave etter 1 utskrift");
		
		double calc = multiManager.doCalculations((x,y) -> x+y, 2.0, 3.5);
		Assertions.assertEquals(5.5, calc, "Teste beregning med addisjon: 2.0 + 3.5");
		Assertions.assertEquals(2, multiManager.getTaskCount(), "Teste antall oppgaver for manager etter 1 utskrift og 1 beregning");
	}
}
