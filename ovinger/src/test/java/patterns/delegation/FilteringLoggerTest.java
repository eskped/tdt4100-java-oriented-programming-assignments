...
public class FilteringLoggerTest{
	...
	public void testFilteringLoggerNoSeverities() {
		...
		Assertions.assertFalse(logger.isLogging(ILogger.WARNING), "Teste logger uten alvorlighetsgrad for warning-logging");
	...
	public void testFilteringLoggerWarningSetIsLoggingError() {
		...
		Assertions.assertFalse(logger.isLogging(ILogger.INFO), "Sette error-logging for warning-logger og teste for info-logging");
		Assertions.assertTrue(logger.isLogging(ILogger.WARNING), "Sette error-logging for warning-logger og teste for warning-logging");
		Assertions.assertTrue(logger.isLogging(ILogger.ERROR), "Sette error-logging for warning-logger og error for info-logging");
	}
	...
	public void testErrorLogging() {
		...
		Assertions.assertEquals(String.format(formatString, ILogger.ERROR, "Noe er feil!", exception), stream.toString().trim(), "Teste formatet på error-melding etter logging");
	}
